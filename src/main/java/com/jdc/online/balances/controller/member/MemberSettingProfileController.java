...
import com.jdc.online.balances.services.LocationService;
import com.jdc.online.balances.services.MemberProfileService;
...
public class MemberSettingProfileController {
	...
	@PostMapping("photo")
	String uploadPhoto(@RequestParam MultipartFile file, HttpServletRequest req) {

		var username = SecurityContextHolder.getContext().getAuthentication().getName();
		
		var imageFolder = req.getServletContext().getRealPath("/resources/photos");
