...
import com.jdc.online.balances.model.entity.embeddable.AccessHistoryPk;
import com.jdc.online.balances.model.entity.embeddable.AccessHistoryPk_;
...
public class AccessHistoryService {
	...
	@Transactional
	private void createHistory(String username, AccessType accessType, AccessStatus accessStatus) {
		createHistory(username, accessType, accessStatus, null);
	}
	...
	private void createHistory(String username, AccessType accessType, AccessStatus accessStatus, String message) {
		...
		history.setId(id);
		history.setType(accessType);
		history.setStatus(accessStatus);
